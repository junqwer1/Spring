...
public class Ex01 {
    ...
    void test1() {
        ...
        Calculator cal1 = new ImplCalculator(); // 성능 좋다
    ...
    @Test
    void test3() {
        Calculator cal1 = new CachedCalculator(new ProxyCalculator(new RecCalculator()));

        long r1 = cal1.factorial(10L);
        System.out.printf("r1 : %d%n", r1);
        long r2 = cal1.factorial(10L);
        System.out.printf("r2 : %d%n", r2);
        long r3 = cal1.factorial(10L);
